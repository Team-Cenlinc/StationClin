...
public class HalfHeight implements Listener {
    ...
    public HalfHeight(Main XecHyperloo) {
        plugin = XecHyperloo;
    }
                ...
                if (e.getClickedBlock().getType().equals(Material.WALL_SIGN)) {
                    ...
                    if (s.getLine(0).equals(ChatColor.AQUA + "[Station]") && s.getLine(2).equals("<Half Height>") && s.getLine(3).equals(ChatColor.AQUA + "[Block Door]")) {
                        ...
                        if (loc1.getBlock().getType().equals(Material.PRISMARINE)) {
                            b.getWorld().playSound(b.getLocation(), Sound.BLOCK_NOTE_BELL, 2, 1);
                            new BukkitRunnable() {
                                @Override
                                public void run() {
                                    //Sound(On)
                                    for (int i = 1; i < 150; i++) {
                                        b.getWorld().playSound(b.getLocation(), Sound.ENTITY_GENERIC_EXTINGUISH_FIRE, 2, 1);
